...
*/
Dataset::Dataset(const char file[], CallbackHandler *c)
{
	init_params(c);
...
*/
Dataset::Dataset(const char file[], int dimensions[], float data_steps[], CallbackHandler *c)
{
	init_params(c);
...
void Dataset::init_params(CallbackHandler *c)
{
