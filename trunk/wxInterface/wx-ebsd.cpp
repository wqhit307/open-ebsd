...
vtkFrameUI::vtkFrameUI( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	bSizer21->Add( grainPropNone, 1, wxEXPAND, 5 );
	
	grainProp = new wxBoxSizer( wxVERTICAL );
	
	showGrainButton = new wxToggleButton( this, wxID_ANY, wxT("Toggle me!"), wxDefaultPosition, wxDefaultSize, 0 );
	grainProp->Add( showGrainButton, 0, wxALL, 5 );
	...
	m_toolBar1->AddTool( wxID_ANY, wxT("Open CSV"), wxNullBitmap, wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString );
	...
	showGrainButton->Connect( wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler( vtkFrameUI::ShowGrain ), NULL, this );
}
...
vtkFrameUI::~vtkFrameUI()
{
	...
	showGrainButton->Disconnect( wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler( vtkFrameUI::ShowGrain ), NULL, this );
}
